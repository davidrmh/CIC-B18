...
Se consideran tres formas de eficiencia en el mercado (citar trabajo de Fama) de acuerdo al tipo de información reflejada:\\

\begin{tabular}{|c|c|c|c|}
\hline Forma de eficiencia & Precios históricos & Información pública & Información privada \\ 
\hline Débil &  &  &  \\ 
\hline Semi fuerte &  &  &  \\ 
\hline Fuerte &  &  &  \\ 
\hline 
...
Por otra lado, en un mercado ineficiente, los inversionistas optarán por seguir una estrategia de \textbf{inversión activa}. Este tipo de inversión busca generar ganancias superiores a aquellas generadas por la inversión pasiva y consiste en lo siguiente: 
...
\subsubsection{Implicaciones del mercado eficiente\\}
